...
use MillerVein\Bundle\CalendarBundle\Model\DateTimeUtility;
...
class PatientTrackerVisit {
     ...
     * @ORM\OneToOne(targetEntity="MillerVein\Bundle\CalendarBundle\Entity\Appointment\PatientAppointment")
     */
