...
namespace MillerVein\Bundle\PatientTrackerBundle\EventListener;

use DateTime;
use Doctrine\ORM\EntityManager;
use Doctrine\ORM\Event\OnFlushEventArgs;
use MillerVein\Bundle\CalendarBundle\Entity\Appointment\PatientAppointment;
use MillerVein\Bundle\PatientTrackerBundle\Entity\PatientTrackerStep;
use MillerVein\Bundle\PatientTrackerBundle\Entity\PatientTrackerVisit;
...
class AppointmentEventListener {
    ...
    protected function createAppointmentReminderStep(EntityManager $entityManager, PatientAppointment $entity) {
        ...
        $stepMetadata = $entityManager->getClassMetadata('MillerVein\Bundle\PatientTrackerBundle\Entity\PatientTrackerStep');
        $visitMetadata = $entityManager->getClassMetadata('MillerVein\Bundle\PatientTrackerBundle\Entity\PatientTrackerVisit');
