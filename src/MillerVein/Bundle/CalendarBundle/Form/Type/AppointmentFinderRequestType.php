...
use MillerVein\Bundle\CalendarBundle\Form\DataTransformer\TimeStringToDateTimeTransformer;
...
class AppointmentFinderRequestType extends AbstractType {
    ...
    public function setDefaultOptions(OptionsResolverInterface $resolver) {
        $resolver->setDefaults(array(
            'data_class' => 'MillerVein\Bundle\CalendarBundle\Model\AppointmentFinderRequest',
        ));
    }
