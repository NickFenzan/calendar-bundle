...
namespace MillerVein\Bundle\CalendarBundle\Form\Type\Appointment;

use Doctrine\ORM\EntityManager;
use Doctrine\ORM\EntityRepository;
use MillerVein\Bundle\CalendarBundle\Model\CalendarColumn;
...
class PatientAppointmentType extends AppointmentType {
    ...
    public function setDefaultOptions(OptionsResolverInterface $resolver) {
        ...
        $resolver->setDefaults(array(
            'data_class' => 'MillerVein\Bundle\CalendarBundle\Entity\Appointment\PatientAppointment',
        ));
    }
