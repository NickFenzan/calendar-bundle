...
use MillerVein\Bundle\CalendarBundle\DomainManager\HoursManager;
use MillerVein\Bundle\CalendarBundle\Entity\Hours;
use MillerVein\Bundle\CalendarBundle\Form\Handler\HoursFormHandler;
...
class HoursController extends Controller {
    ...
    public function indexAction() {
        $form = $this->createForm('hours_admin');
