...
use MillerVein\Bundle\CalendarBundle\Session\LegacySessionStorage;
use MillerVein\Bundle\CalendarBundle\Session\RootAttributeBag;
...
class TestController extends Controller {
    ...
    public function yoAction(){
        ...
        $site = new \MillerVein\Bundle\EMRBundle\Entity\Site();
        $category = new \MillerVein\Bundle\CalendarBundle\Entity\Category\Category();
