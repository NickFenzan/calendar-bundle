...
namespace MillerVein\Bundle\CalendarBundle\Entity\Appointment;

use DateTime;
use Doctrine\ORM\Mapping as ORM;
use MillerVein\Bundle\CalendarBundle\Entity\AppointmentStatus;
use MillerVein\Bundle\CalendarBundle\Entity\Category\Category;
use MillerVein\Bundle\CalendarBundle\Entity\Column;
use MillerVein\Bundle\CalendarBundle\Validator as MVAssert;
...
// <editor-fold defaultstate="collapsed" desc="Properties">
     ...
     * @ORM\ManyToOne(targetEntity="MillerVein\Bundle\CalendarBundle\Entity\Column")
     * @Assert\NotBlank()
     * @var Column
     */
    protected $column;
     ...
     * @ORM\ManyToOne(targetEntity="MillerVein\Bundle\CalendarBundle\Entity\Category\Category")
     * @Assert\NotBlank()
     * @var Category
     */
    protected $category;
    ...
    /**
     * Appointment Status
     * @ORM\ManyToOne(targetEntity="MillerVein\Bundle\CalendarBundle\Entity\AppointmentStatus")
