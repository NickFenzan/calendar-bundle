...
namespace MillerVein\Bundle\CalendarBundle\Model\Collections;

use Doctrine\Common\Collections\ArrayCollection;
use Exception;
use MillerVein\Bundle\CalendarBundle\Model\TimeSlot;
...
class TimeSlotCollection extends ArrayCollection {
    ...
    const CLASS_NAME = '\MillerVein\Bundle\CalendarBundle\Model\TimeSlot';
    ...
    public function applyAppointmentFragmentCollection(AppointmentFragmentCollection &$appointment_fragment_collection){
        foreach($appointment_fragment_collection as $key=>$fragment){
            /* @var $fragment \MillerVein\Bundle\CalendarBundle\Model\AppointmentFragment */
            foreach($this->toArray() as $timeslot){
                /* @var $timeslot \MillerVein\Bundle\CalendarBundle\Model\TimeSlot */
