...
use EMR\Bundle\CalendarBundle\Validator as MVAssert;
...
// <editor-fold defaultstate="collapsed" desc="Properties">
     ...
     * @ORM\ManyToOne(targetEntity="EMR\Bundle\CalendarBundle\Entity\Category\Category")
     * @Assert\NotBlank()
     * @var Category
     */
    protected $category;
    ...
    /**
     * Appointment Status
     * @ORM\ManyToOne(targetEntity="EMR\Bundle\CalendarBundle\Entity\AppointmentStatus")
